import './style.css';
const PROFILE = {"day":"Day011","title":"Concept Gap Mapper","one_sentence":"つまずきポイントを前提不足として可視化する学習診断ツール。（話題:HN Frontpage）","core_action":"map","family":"knowledge_gap","mechanic":"dependency_mapping","input_style":"confusion_notes","output_style":"gap_map","audience_promise":"clearer_study_path","publish_hook":"何が足りないかを前提マップで見える化","engine":"decision_brief"};
